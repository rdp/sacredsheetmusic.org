...
ActiveRecord::Schema.define(:version => 20100210194537) do
  ...
  add_index "items", ["name", "code", "is_discontinued", "date_available", "quantity", "variation_quantity", "type"], :name => "search", :length => {"type"=>nil, "date_available"=>nil, "variation_quantity"=>nil, "quantity"=>nil, "is_discontinued"=>nil, "code"=>"255", "name"=>nil}
