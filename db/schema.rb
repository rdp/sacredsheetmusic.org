...
ActiveRecord::Schema.define(:version => 20100210194537) do
  ...
  create_table "cache", :force => true do |t|
    t.integer "hash_key",         :limit => 8
    t.text    "marshalled_value", :limit => 2147483647
    t.text    "string_value",     :limit => 2147483647
    t.integer "parent_id",        :limit => 8
    t.string  "cache_type"
  end

  add_index "cache", ["hash_key"], :name => "index_cache_on_hash_key"
  add_index "cache", ["parent_id"], :name => "index_cache_on_parent_id"
  ...
  create_table "comments", :force => true do |t|
    ...
    t.datetime "created_at"
    t.string   "created_ip"
    t.string   "created_session"
    t.integer  "created_admin_user_id"
  end

  add_index "comments", ["product_id"], :name => "pid"
  ...
  create_table "items", :force => true do |t|
    t.string   "code",                  :limit => 1000,       :default => "",    :null => false
    t.string   "name",                  :limit => 100,        :default => "",    :null => false
    t.text     "description"
    ...
    t.boolean  "wants_reviews",                               :default => false
    t.text     "lyrics",                :limit => 2147483647
    t.boolean  "is_competition_winner",                       :default => false
    t.text     "thumbnail_html_cache",  :limit => 2147483647
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "items", ["date_available", "is_discontinued", "quantity", "variation_quantity", "type"], :name => "tag_view"
  add_index "items", ["name", "code", "is_discontinued", "date_available", "quantity", "variation_quantity", "type"], :name => "search", :length => {"quantity"=>nil, "code"=>"255", "date_available"=>nil, "name"=>nil, "is_discontinued"=>nil, "variation_quantity"=>nil, "type"=>nil}
  ...
  create_table "orders", :force => true do |t|
    ...
    t.integer  "affiliate_id",           :default => 0,   :null => false
    t.integer  "affiliate_payment_id",   :default => 0,   :null => false
  end
  ...
  create_table "tags", :force => true do |t|
    ...
    t.string  "composer_contact_url"
    t.boolean "is_voicing",                                             :default => false
    t.string  "composer_url"
    t.string  "name_in_nav"
  ...
  add_index "wishlist_items", ["session_id"], :name => "user"
