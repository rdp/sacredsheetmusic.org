  ...
  def save
    ...
    if @product.save
      ...
      if @product.hymn_tag
        ...
        flash[:notice] += "<br/> Warning: no hymn tag selected. This might be right if it's an original or primary piece though (topics must be added later in that case though)"
      end
